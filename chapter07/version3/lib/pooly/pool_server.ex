defmodule Pooly.PoolServer do
  ...
  def handle_info({:EXIT, pid, _reason},
                  %{workers: workers, monitors: monitors, worker_sup: worker_sup} = state) do
  ...
  defp supervisor_spec(name, mfa) do
    # `restart` is set to temporary is because the WorkerSupervisor is started by the PoolServer.
